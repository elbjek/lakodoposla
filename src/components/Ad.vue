<template>
  <div v-if="ad" class="single-ad-component">
    ...
    <div v-if="marker === 'latest' || marker === 'all'">
      <p v-if="ad.short_description">{{ ad.short_description }}</p>
    ...
    <div class="single-ad-component-additional-info" v-if="$route.path === '/oglasi/' + ad.id">
      <div class="single-ad-component-additional-info-conditions"
        v-if="ad.work_conditions.length > 0">
        <p>Uslovi za rad:</p>
        <ul>
      ...
      <div class="single-ad-component-additional-info-traits" v-if="ad.employee_traits.length > 0">
        <p>Licne osobine:</p>
        <ul>
